...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://mimic.mit.edu/fhir/mimic/StructureDefinition/dilution-details']) &lt;= 1">extension with URL = 'http://mimic.mit.edu/fhir/mimic/StructureDefinition/dilution-details': maximum cardinality of 'extension' is 1</sch:assert>
